...
* **Site-Wide Dark Mode:** Implements CSS Variables for a seamless, user-toggled light/dark theme.
* **Advanced UI/UX:** Features a JavaScript-powered typewriter effect, parallax background scrolling, and smooth scroll navigation.
* **Responsive Architecture:** Built with CSS Flexbox and Grid to ensure perfect layouts across mobile, tablet, and desktop screens.
